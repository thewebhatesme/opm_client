...
class ConfigTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @covers Whm\Opm\Client\Config\Config::getPhantomJsExecutable
     */
    public function testGetPhantomJsExecutable()
    {
        $this->assertEquals(
                $this->object->getPhantomJsExecutable(), $this->mockConfigArray['phantom']['executable']
        );
    }
