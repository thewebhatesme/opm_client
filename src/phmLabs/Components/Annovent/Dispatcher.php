...
class Dispatcher implements DispatcherInterface
{
    ...
    /**
     * This function is used to call all listeners.
     * It stops processing if the $until parameter is true and the
     * event is processed.
     *
     * @param Event $event
    ...
    /**
     * Connectes an array of listeners to the dispatcher.
     *
     *
     * @param array $listeners
     * @param unknown_type $priority
     */
    public function connectListeners (array $listeners, $priority = 0)
    {
        foreach ($listeners as $listener) {
            $this->connectListener($listener, $priority);
        }
    }

    /**
     * This function is used to register a listener.
     * Listeners are normal classes that are
